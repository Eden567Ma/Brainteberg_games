...
if len(args.filenames) == 1:
    ...
    for l in lines[0]:
        ...
        i = i + 1
    traceData( xData, yData, title=args.title, ylimMin=args.ylimMin, ylimMax=args.ylimMax, xlimMin=args.xlimMin, xlimMax=args.xlimMax, autoscaling=args.autoscaling, locLegend=args.locLegend, xLabel="Evaluation", yLabel=" Distance", outputFilename=args.outputFilename)
else:
    ...
    traceData( xData, yData, type="multi", title=args.title, ylimMin=args.ylimMin, ylimMax=args.ylimMax, xlimMin=args.xlimMin, xlimMax=args.xlimMax, autoscaling=args.autoscaling, locLegend=args.locLegend, xLabel=args.xLabel, yLabel=args.yLabel, outputFilename=args.outputFilename)
